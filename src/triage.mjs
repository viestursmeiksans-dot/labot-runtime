...
export const TIERS = {
  trivial:     { model: "claude-haiku-4-5-20251001", maxTurns: 4,  maxEdit: 200,       browserVerify: false },
  mechanical:  { model: "claude-haiku-4-5-20251001", maxTurns: 6,  maxEdit: 400,       browserVerify: false },
  judgment:    { model: "claude-sonnet-4-6",         maxTurns: 10, maxEdit: 600,       browserVerify: false },
  structural:  { model: "claude-opus-4-8",           maxTurns: 20, maxEdit: Infinity,  browserVerify: false },
  interactive: { model: "claude-sonnet-4-6",         maxTurns: 12, maxEdit: 600,       browserVerify: true  },
};
...
// Structural: moving/adding sections or pages, restyling a group.
const STRUCTURAL = /\b(add (a )?(section|page|block)|new (section|page)|remove (the )?section|reorder|move (the|that) (section|block)|restructure|redesign|jaun(a|u) (sadaļ|lap)|pievieno.*(sadaļ|lap)|pārkārto|pārveido layout)/i;
